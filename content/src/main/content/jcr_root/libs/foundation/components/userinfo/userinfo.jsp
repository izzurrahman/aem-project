...
%><%@taglib prefix="personalization" uri="http://www.day.com/taglibs/cq/personalization/1.0" %><%
    ...
    String anonymousId = StringUtils.EMPTY;
    if(userManagementService != null) {
        anonymousId = userManagementService.getAnonymousId();
    }
...
<% if (!isDisabled) { %>
    if (CQ_Analytics && CQ_Analytics.CCM) {
        CQ_Analytics.ProfileDataMgr.loadProfile("<%= xssAPI.encodeForJSString(anonymousId) %>");
